  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ AddressIofo.fullAddress }}</span>
        收货人：<span>{{ AddressIofo.consignee }}</span>
        <span>{{ AddressIofo.phoneNum }}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <a href="###" class="subBtn" @click="goPay">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async goPay() {
      ...
      let data = {
        consignee: this.AddressIofo.consignee,
        consigneeTel: this.AddressIofo.phoneNum,
        deliveryAddress: this.AddressIofo.fullAddress,
        paymentWay: "ONLINE",
